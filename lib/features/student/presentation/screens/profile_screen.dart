...
class StudentProfileScreen extends StatelessWidget {
      ...
      children: [
        ...
        Column(
          children: [
            ...
            const Text("السنة الأولى _ الفصل الثاني", 
          ...
          onTap: () {
            ...
            if(tab >= 0) {
              Navigator.pushAndRemoveUntil(context, 
                MaterialPageRoute(builder: (c) => NavigationWrapper(initialIndex: tab, isGuest: isGuest)), 
                (r) => false);
            } else {
              Navigator.push(context, 
                MaterialPageRoute(builder: (c) => ExamsScreen(isGuest: isGuest)));
            }
          },
          child: Opacity(
  ...
  Widget _row(String t, IconData i, Color c) => Padding(
