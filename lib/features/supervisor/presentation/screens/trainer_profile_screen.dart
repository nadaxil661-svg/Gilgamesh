...
class TrainerProfileScreen extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: CircleAvatar(
                ...
                child: CircleAvatar(
                  radius: 52, 
                  backgroundImage: AssetImage(trainerData["img"] ?? "assets/مدرب1.png"),
                ),
              ),
            ),
            const SizedBox(height: 12),
            Text(trainerData["name"] ?? "اسم المدرب", 
              style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black)),
            Text(trainerData["job"] ?? "التخصص", 
  ...
  Widget _buildStat(IconData i, String v, String l) {
    return Column(
      children: [
        Icon(i, color: AppColors.primaryDark, size: 28), 
  ...
  Widget _buildBioSection() {
    return Padding(
      ...
      child: Text(
        ...
        style: const TextStyle(fontSize: 14, height: 1.7, color: Colors.black87, fontWeight: FontWeight.w500),
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: const Row(
          ...
          children: [
            Icon(Icons.picture_as_pdf_outlined, color: Colors.grey, size: 22), 
            SizedBox(width: 8), 
