...
/// واجهة العلامات كاملة التنسيق وبدون اختصارات
/// تم استعادة كافة المواد (8 مواد) والرسوم البيانية والإحصائيات العلوية
class GradesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // القائمة الكاملة للمواد والدرجات (8 مواد كما طلبت)
              ...
              Row(
                ...
                children: [
                  const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("نتائجك الدراسية", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black87)),
                      Text("إحصائيات الفصل الحالي 2025/2026", style: TextStyle(fontSize: 12, color: Colors.black54)),
                    ],
                  ),
                  IconButton(
  ...
  Widget _buildGradeCard(Map<String, dynamic> item) {
    ...
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(item['title'], textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
          Stack(
            ...
            children: [
              ...
              Text("${item['grade']}%", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
            ],
          ),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 3),
            decoration: BoxDecoration(color: itemColor.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(10)),
            child: Text(item['status'], style: TextStyle(color: itemColor, fontSize: 10, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
      ...
      child: const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text("هذه البيانات متاحة للطلاب فقط", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Text("يرجى تسجيل الدخول كطالب لرؤية درجاتك", style: TextStyle(fontSize: 14, color: Colors.grey)),
          ],
        ),
      ),
    );
